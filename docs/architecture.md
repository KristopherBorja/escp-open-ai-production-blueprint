...
The deployment workflow syncs verified `main` to one public Static Space using a repository-scoped secret and a protected GitHub environment. A rollback is:
