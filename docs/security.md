...
| Container privilege or server defaults                     | Multi-stage image, pinned base tags, user `101`, unprivileged port, tested headers and health route                          | Image tags can be republished; production operators should add digest pinning and image scanning.     |
